...
#define USE_GL 1
	...
	//define this:
	extern void update(double time, double deltaTime, int width, int height, int nSamples, float *samples);
#else
	...
	//define this:
	extern void update(double time, double deltaTime, int nSamples, float *samples);
